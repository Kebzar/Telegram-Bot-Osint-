...
if BOT_TOKEN == 'YOUR_BOT_TOKEN_HERE':
    logger.warning("⚠️ BOT_TOKEN non configurato! Configura la variabile d'ambiente TELEGRAM_BOT_TOKEN")
...
- Query: {query}"""
    ...
    # ============ FUNZIONI DI RICERCA SPECIFICHE (ESISTENTI) ============
